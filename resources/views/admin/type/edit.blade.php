                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="/admin/type/{{$info->tid}}" method="post">
                                        ...
                                        <select name="pid" disabled>
                                            <option value="0">顶级分类</option>
                                                @foreach ($res as $k=>$v)
                                                    ...
                                                    ?>
                                                        <option value="{{$v['tid']}}" @if($info->pid == $v->tid) selected @endif >{{str_repeat('&nbsp;',$n*7)}}|--{{$v['tname']}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="tname" value="{{$info->tname}}" placeholder="请输入类别">
                                    </div>
                                </div>
