...
<link href="/homes/jsy/css/orstyle.css" rel="stylesheet" type="text/css">
<script src="/homes/jsy/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
											...
											<div class="order-right">
												...
												<div class="move-right">
													<li class="td td-status">
														<div class="item-status">
															<p class="Mystatus">交易成功</p>
															<p class="order-info"><a href="/homeorders/ordersinfo">订单详情</a></p>
															<p class="order-info"><a href="logistics.html">查看物流</a></p>
														</div>
													</li>
													<li class="td td-change">
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"><a href="/homeorders/orders">订单管理</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的小窝</a>
